...
public class Mp4VideoUtil extends VideoUtil {
    ...
    public String generateMp4(){
        ...
        // 命令：ffmpeg.exe -i  lucene.avi -c:v libx264 -s 1280x720 -pix_fmt yuv420p -b:a 63k -b:v 753k -r 18 .\lucene.mp4
    ...
    public static void main(String[] args) throws IOException {
        //ffmpeg的路径
        String ffmpeg_path = "D:\\Environment\\ffmpeg-117701-gpl\\bin\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\video\\nb2.avi";
        //转换后mp4文件的名称
        String mp4_name = "5540028316.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\video\\54002831_nb2.mp4";
        //创建工具类对象
